...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_sideMenu_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_sideMenu_t qt_meta_stringdata_sideMenu = {
    {
        QT_MOC_LITERAL(0, 8)   // "sideMenu"
    },
    "sideMenu"
};
...
Q_CONSTINIT static const uint qt_meta_data_sideMenu[] = {
...
Q_CONSTINIT const QMetaObject sideMenu::staticMetaObject = { {
    ...
    qt_meta_stringdata_sideMenu.offsetsAndSizes,
    qt_meta_data_sideMenu,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_sideMenu_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<sideMenu, std::true_type>
    >,
    nullptr
} };
